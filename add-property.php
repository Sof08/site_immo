...
<body class="body bg-surface">
            ...
            <div class="layout-wrap">
                            ...
                            <div class="col-lg-12">
                                <div class="inner-container d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="logo-box d-flex">
                                        <div class="logo"><a href="index.html"><img src="images/logo/logo@2x.png"
                ...
                <div class="sidebar-menu-dashboard">
                    <ul class="box-menu-dashboard">
                        <li class="nav-menu-item"><a class="nav-menu-link" href="dashboard.html"><span
                        ...
                        <li class="nav-menu-item active"><a class="nav-menu-link" href="add-property.html">
                                ...
                                Add Property</a></li>
                        <li class="nav-menu-item"><a class="nav-menu-link" href="index.html"><span
                                    class="icon icon-sign-out"></span> Logout</a></li>
                    </ul>
                </div>
                <!-- end sidebar dashboard -->
                <form action="modules/annonce/ajouter_annonce.php" method="post">
                        ...
                        <div class="main-content-inner">
                                ...
                                <div class="box-uploadfile text-center">
                                    <label class="uploadfile">
                                        ...
                                        <div class="btn-upload">
                                            ...
                                            <input type="file" name="image" class="ip-file">
                                        </div>
                            ...
                            <div class="widget-box-2">
                                ...
                                <div class="box-info-property">
                                    <fieldset class="box box-fieldset">
                                        ...
                                        <input type="text" name="titre" class="form-control style-1">
                                    </fieldset>
                                    <fieldset class="box box-fieldset">
                                        <label for="desc">Description:</label>
                                        <textarea class="textarea-tinymce" name="description">
                                        </textarea>
                                    </fieldset>
                                    <div class="box grid-3 gap-30">
                                        <fieldset class="box-fieldset">
                                            ...
                                            <input type="text" name="addresse" class="form-control style-1"
                                    ...
                                    <div class="box box-fieldset">
                                        ...
                                        <div id="map-single" class="map-single" data-map-zoom="16"
                                ...
                                <div class="box-price-property">
                                    <div class="box grid-2 gap-30">
                                        <fieldset class="box-fieldset">
                                            ...
                                            <input type="text" class="form-control style-1" name="prix"
                            ...
                            <div class="widget-box-2">
                                ...
                                <div class="box grid-3 gap-30">
                                    ...
                                    <fieldset class="box-fieldset">
                                        <label for="status">
                                            Statut du bien:<span>*</span>
                                        </label>
                                        <div class="nice-select" tabindex="0"><span class="current"></span>
                                            <ul class="list" name="statut_bien">
                                                <li data-value="1" class="option" value="louer">À louer</li>
                                                <li data-value="2" class="option" value="vendre">À vendre</li>
                                            </ul>
                                            <!--<select name="statut_bien" style="display:none;">
    ...
    <script type="text/javascript" src="js/tinymce/tinymce-custom.js"></script>
